...
import io.github.itsflicker.tools.module.command.impl.*
...
import io.github.itsflicker.tools.util.spawnRandomFirework
 ...
 */
@CommandHeader("itstools", ["it"], description = "Main command of ItsTools", permission = "itstools.command.tools")
object CommandTools {
